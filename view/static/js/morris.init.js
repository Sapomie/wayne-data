!function (e) {
    ...
    a.prototype.createLineChart = function (e, a, r, t, i, o) {
        ...
        this.createLineChart("morris-line-example", [{y: "2009", a: 50, b: 80, c: 20}, {
            y: "2010",
            a: 130,
            b: 100,
            c: 80
        }, {y: "2011", a: 80, b: 60, c: 70}, {y: "2012", a: 70, b: 200, c: 140}, {
            y: "2013",
            a: 180,
            b: 140,
            c: 150
        ...
        this.createBarChart("morris-bar-example", [{y: "2009", a: 100, b: 90}, {y: "2010", a: 75, b: 65}, {
            y: "2011",
            a: 50,
            b: 40
            ...
            a: 100,
            b: 90
        }, {y: "2016", a: 90, b: 75}], "y", ["a", "b"], ["Series A", "Series B"], ["#7a6fbe", "#28bbe3"]);
        this.createAreaChart("morris-area-example", 0, 0, [{y: "2007", a: 0, b: 0, c: 0}, {
            y: "2008",
            a: 150,
            b: 45,
            c: 15
        }, {y: "2009", a: 60, b: 150, c: 195}, {y: "2010", a: 180, b: 36, c: 21}, {
            y: "2011",
            a: 90,
            b: 60,
            c: 360
