...
!function (e) {
    ...
    i.prototype = {
        clear: function () {
            this.$element.val(""), this.$elementFilestyle.find(":text.json").val(""), this.$elementFilestyle.find(".badge").remove()
        }, destroy: function () {
            ...
            if (e === !0) this.options.input || (this.options.input = e, this.options.buttonBefore ? this.$elementFilestyle.append(this.htmlInput()) : this.$elementFilestyle.prepend(this.htmlInput()), this.pushNameFiles(), this.$elementFilestyle.find(".group-span-filestyle").addClass("input-group-btn")); else {
                ...
                this.options.input && (this.options.input = e, this.$elementFilestyle.find(":text.json").remove(), this.$elementFilestyle.find(".group-span-filestyle").removeClass("input-group-btn"))
            }
        }, size: function (e) {
            ...
            return void 0 === e ? this.options.text : (this.options.text = e, void this.$elementFilestyle.find("label .text.json").html(this.options.text))
        }, btnClass: function (e) {
            ...
            return this.options.input ? '<input type="text.json" class="form-control ' + ("nr" == this.options.size ? "" : "form-control-" + this.options.size) + '" placeholder="' + this.options.placeholder + '" disabled> ' : ""
        }, pushNameFiles: function () {
            var e = "", t = [];
            void 0 === this.$element[0].files ? t[0] = {name: this.$element[0] && this.$element[0].value} : t = this.$element[0].files;
            for (var i = 0; i < t.length; i++) e += t[i].name.split("\\").pop() + ", ";
            return "" !== e ? this.$elementFilestyle.find(":text.json").val(e.replace(/\, $/g, "")) : this.$elementFilestyle.find(":text.json").val(""), t
